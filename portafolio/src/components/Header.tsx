      ...
      <div className="flex flex-col items-start text-left mb-12">
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2.5 bg-slate-200 text-slate-900 border border-slate-300 px-6 py-3 rounded-lg font-mono text-sm hover:border-brand-400 hover:text-brand-300 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-brand-400"
          >
